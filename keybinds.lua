...
hl.define_submap("AUDIO", function()
  ...
  bind("K", exec("playerctl volume 0.05+"))
  bind("J", exec("playerctl volume 0.05-"))
  bind("SHIFT + K", exec("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+"))
  bind("SHIFT + J", exec("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"))
  bind("ESCAPE", submap("reset"))
end)
